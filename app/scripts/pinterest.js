  ...
  var $ = (w[a.k] = {
    ...
    f: (function() {
      return {
        ...
        btoa: function(s) {
          let d = "data:image/svg+xml;base64,";
          if ($.w.btoa) {
            d = d + $.w.btoa(s);
          } else {
            for (
        ...
        log: function(str) {
          ...
          if (
            ...
            let query = "?type=pidget&guid=" + $.v.guid;
            ...
            if (o.href) {
              ...
              if (
                ...
                $.w.open(
                  ...
                  $.a.pop.base.replace("%dim%", $.a.pop.small)
                );
              } else {
                // log an error
                $.f.log(
        ...
        showHoverButton: function(el, sticky) {
          ...
          if (h > $.a.hoverButtonMinImgSize && w > $.a.hoverButtonMinImgSize) {
            ...
            let buttonClass = $.a.k + "_button_pin";
            if (c.round) {
        ...
        structure: {
          buttonPin: function(r, options) {
            let template, formatCount, formattedCount, sep;
            template = {
          ...
          embedPin: function(r, options) {
            let p, template, langMod, widthMain, widthMod, thumb, saves, done;
            if (r.data && r.data[0]) {
              p = r.data[0];
              if (p.error) {
                $.f.log(
                  "&event=api_error&code=embed_pin_not_found&pin_id=" + p.id
                );
                return false;
              }
              if (!p.rich_metadata) {
              ...
              if (
                options.width &&
                (options.width === "medium" || options.width === "large")
              ) {
              ...
              template = {
                ...
                bd: {
                  hd: {
                    ...
                    container: {
                      paddingBottom:
                        ~~((thumb.height / thumb.width) * 10000) / 100 + "%",
                      // main image
                      img: {
                  ...
                  source: {
                    ...
                    domain: {
                      text:
                        p.rich_metadata.site_name ||
                        $.a.strings[options.lang]["from"].replace(
                          /%s/,
                          p.domain
                        ),
                    },
                ...
                ft: {
                  href: p.pinner.profile_url.replace(
                    /https?:\/\/www\.pinterest\.com\//,
                    $.v.config.pinterest + "/"
                  ),
                  log: "embed_pin_pinner" + widthMod,
                  img: {
                    backgroundImage: p.pinner.image_small_url.replace(
                      /30x30_/,
                      "60x60_"
                    ),
                  },
              ...
              if (
                p.attribution &&
                p.attribution.author_name &&
                p.attribution.author_url
              ) {
                ...
                template.bd.attribution = {
                  ...
                  // translated string
                  by: {
                    text: $.a.strings[options.lang]["by"].replace(
                      /%s/,
                      p.attribution.author_name
                    ),
                  },
              ...
              if (
                p.videos &&
                p.videos.video_list &&
                p.videos.video_list.V_HLSV4 &&
                p.videos.video_list.V_720P
              ) {
              ...
              if (
                ...
                p.aggregated_pin_data.aggregated_stats
              ) {
        ...
        getLegacy: {
          grid: function(a, o) {
            let scaleHeight = parseInt($.f.getData(a, "scale-height"));
            let scaleWidth = parseInt($.f.getData(a, "scale-width"));
            let boardWidth = parseInt($.f.getData(a, "board-width"));
        ...
        seek: {
          buttonPin: function(a) {
            ...
            if (o.custom) {
              ...
              if (!k) {
                let s = $.f.structure.buttonPin(a, o);
                $.f.replace(a, s);
              }
            }
          },
          ...
          embedPin: function(a) {
            ...
            if (p.length) {
              ...
              $.f.call(
                $.a.endpoint.pin.replace(/%s/, p[1]) + "&sub=" + $.v.sub + bs,
                function(r) {
        ...
        exposeUtil: function() {
          ...
          let util = ($.w[$.v.config.util] = $.f.util);
        ...
        config: function() {
          let script = $.d.getElementsByTagName("SCRIPT"),
            i,
            j,
            n,
            p;
        ...
        langLocLookup: function() {
          let t, i, lang, locale, hazAltDomain, q;
